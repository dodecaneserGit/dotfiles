...
# guardando los resultados en un archivo llamado alive_domains.

echo $red'[+]FINDING LIVE HOSTS...'$end

cat all_domains.txt | httprobe > alive_domains.txt
echo $red'[+]Saved live hosts to alive_domains.txt'$end

#result="cat alive_domains.txt"
#    message="[ + ] mainRecon Alert:
#    [ --> ] alive_domains.txt for: $program
#    $($result)"
