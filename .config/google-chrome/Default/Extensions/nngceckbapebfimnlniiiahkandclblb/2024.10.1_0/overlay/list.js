...
;// CONCATENATED MODULE: ./src/autofill/deprecated/overlay/pages/list/autofill-overlay-list.deprecated.ts
var autofill_overlay_list_deprecated_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class AutofillOverlayList extends autofill_overlay_page_element_deprecated {
    constructor() {
        super();
    ...
    initAutofillOverlayList({ translations, styleSheetUrl, theme, authStatus, ciphers, }) {
        return autofill_overlay_list_deprecated_awaiter(this, void 0, void 0, function* () {
...
/* harmony default export */ var autofill_overlay_list_deprecated = (AutofillOverlayList);

;// CONCATENATED MODULE: ./src/autofill/deprecated/overlay/pages/list/bootstrap-autofill-overlay-list.deprecated.ts


__webpack_require__(13091);
(function () {
    globalThis.customElements.define(AutofillOverlayElement.List, autofill_overlay_list_deprecated);
})();
