...
;// CONCATENATED MODULE: ./src/autofill/overlay/inline-menu/pages/button/autofill-inline-menu-button.ts
...
class AutofillInlineMenuButton extends AutofillInlineMenuPageElement {
     ...
     * @param portKey - Background generated key that allows the port to communicate with the background
     */
    initAutofillInlineMenuButton({ authStatus, styleSheetUrl, translations, portKey, }) {
        return autofill_inline_menu_button_awaiter(this, void 0, void 0, function* () {
...
;// CONCATENATED MODULE: ./src/autofill/overlay/inline-menu/pages/button/bootstrap-autofill-inline-menu-button.ts


__webpack_require__(57325);
(function () {
