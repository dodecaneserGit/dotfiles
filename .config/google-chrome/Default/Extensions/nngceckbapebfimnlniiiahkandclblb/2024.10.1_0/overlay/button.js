...
;// CONCATENATED MODULE: ./src/autofill/deprecated/overlay/pages/shared/autofill-overlay-page-element.deprecated.ts
...
/* harmony default export */ var autofill_overlay_page_element_deprecated = (AutofillOverlayPageElement);

;// CONCATENATED MODULE: ./src/autofill/deprecated/overlay/pages/button/autofill-overlay-button.deprecated.ts
var autofill_overlay_button_deprecated_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class AutofillOverlayButton extends autofill_overlay_page_element_deprecated {
    constructor() {
        super();
        this.authStatus = AuthenticationStatus.LoggedOut;
        this.overlayButtonWindowMessageHandlers = {
            ...
            updateAutofillOverlayButtonAuthStatus: ({ message }) => this.updateAuthStatus(message.authStatus),
     ...
     * @private
     */
    initAutofillOverlayButton({ authStatus, styleSheetUrl, translations, }) {
        return autofill_overlay_button_deprecated_awaiter(this, void 0, void 0, function* () {
...
/* harmony default export */ var autofill_overlay_button_deprecated = (AutofillOverlayButton);

;// CONCATENATED MODULE: ./src/autofill/deprecated/overlay/pages/button/bootstrap-autofill-overlay-button.deprecated.ts


__webpack_require__(16399);
(function () {
    globalThis.customElements.define(AutofillOverlayElement.Button, autofill_overlay_button_deprecated);
})();
