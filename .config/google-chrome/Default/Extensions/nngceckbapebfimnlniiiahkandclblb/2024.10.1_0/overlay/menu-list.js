...
;// CONCATENATED MODULE: ./src/autofill/overlay/inline-menu/pages/shared/autofill-inline-menu-page-element.ts
...
;// CONCATENATED MODULE: ./src/autofill/overlay/inline-menu/pages/list/autofill-inline-menu-list.ts
...
class AutofillInlineMenuList extends AutofillInlineMenuPageElement {
    constructor() {
        ...
        this.inlineMenuListWindowMessageHandlers = {
            ...
            updateAutofillInlineMenuListCiphers: ({ message }) => this.updateListItems(message.ciphers, message.showInlineMenuAccountCreation),
     ...
     */
    initAutofillInlineMenuList({ translations, styleSheetUrl, theme, authStatus, ciphers, portKey, filledByCipherType, showInlineMenuAccountCreation, showPasskeysLabels, }) {
    ...
    addFillCipherElementAriaDescription(fillCipherElement, cipher) {
        ...
        if (cipher.login) {
            ...
            if (username) {
                fillCipherElement.setAttribute("aria-description", `${this.getTranslation("username")}: ${username}`);
            }
            return;
        }
        if (cipher.card) {
...
;// CONCATENATED MODULE: ./src/autofill/overlay/inline-menu/pages/list/bootstrap-autofill-inline-menu-list.ts
