...
AutoFillConstants.AmbiguousTotpFieldNames = ["code", "pin", "otc", "otp"];
...
class AutofillOverlayContentService {
    constructor(domQueryService, inlineMenuFieldQualificationService) {
         ...
         */
        this.handleGetFormFieldDataForNotificationMessage = () => autofill_overlay_content_service_awaiter(this, void 0, void 0, function* () {
            if (yield this.isFieldCurrentlyFocused()) {
                return;
            }
         ...
         */
        this.getFormFieldDataForNotification = () => {
            var _a, _b, _c;
            return {
    ...
    addNewVaultItem({ addNewCipherType }) {
        ...
        return autofill_overlay_content_service_awaiter(this, void 0, void 0, function* () {
            ...
            const password = ((_a = this.userFilledFields["newPassword"]) === null || _a === void 0 ? void 0 : _a.value) || ((_b = this.userFilledFields["password"]) === null || _b === void 0 ? void 0 : _b.value);
            if (addNewCipherType === CipherType.Login) {
                const login = {
                    username: ((_c = this.userFilledFields["username"]) === null || _c === void 0 ? void 0 : _c.value) || "",
                    password: password || "",
                    uri: globalThis.document.URL,
            ...
            if (addNewCipherType === CipherType.Card) {
                const card = {
                    cardholderName: ((_d = this.userFilledFields["cardholderName"]) === null || _d === void 0 ? void 0 : _d.value) || "",
                    number: ((_e = this.userFilledFields["cardNumber"]) === null || _e === void 0 ? void 0 : _e.value) || "",
                    expirationMonth: ((_f = this.userFilledFields["cardExpirationMonth"]) === null || _f === void 0 ? void 0 : _f.value) || "",
                    expirationYear: ((_g = this.userFilledFields["cardExpirationYear"]) === null || _g === void 0 ? void 0 : _g.value) || "",
                    expirationDate: ((_h = this.userFilledFields["cardExpirationDate"]) === null || _h === void 0 ? void 0 : _h.value) || "",
                    cvv: ((_j = this.userFilledFields["cardCvv"]) === null || _j === void 0 ? void 0 : _j.value) || "",
                };
            ...
            if (addNewCipherType === CipherType.Identity) {
                const identity = {
                    title: ((_k = this.userFilledFields["identityTitle"]) === null || _k === void 0 ? void 0 : _k.value) || "",
                    firstName: ((_l = this.userFilledFields["identityFirstName"]) === null || _l === void 0 ? void 0 : _l.value) || "",
                    middleName: ((_m = this.userFilledFields["identityMiddleName"]) === null || _m === void 0 ? void 0 : _m.value) || "",
                    lastName: ((_o = this.userFilledFields["identityLastName"]) === null || _o === void 0 ? void 0 : _o.value) || "",
                    fullName: ((_p = this.userFilledFields["identityFullName"]) === null || _p === void 0 ? void 0 : _p.value) || "",
                    address1: ((_q = this.userFilledFields["identityAddress1"]) === null || _q === void 0 ? void 0 : _q.value) || "",
                    address2: ((_r = this.userFilledFields["identityAddress2"]) === null || _r === void 0 ? void 0 : _r.value) || "",
                    address3: ((_s = this.userFilledFields["identityAddress3"]) === null || _s === void 0 ? void 0 : _s.value) || "",
                    city: ((_t = this.userFilledFields["identityCity"]) === null || _t === void 0 ? void 0 : _t.value) || "",
                    state: ((_u = this.userFilledFields["identityState"]) === null || _u === void 0 ? void 0 : _u.value) || "",
                    postalCode: ((_v = this.userFilledFields["identityPostalCode"]) === null || _v === void 0 ? void 0 : _v.value) || "",
                    country: ((_w = this.userFilledFields["identityCountry"]) === null || _w === void 0 ? void 0 : _w.value) || "",
                    company: ((_x = this.userFilledFields["identityCompany"]) === null || _x === void 0 ? void 0 : _x.value) || "",
                    phone: ((_y = this.userFilledFields["identityPhone"]) === null || _y === void 0 ? void 0 : _y.value) || "",
                    email: ((_z = this.userFilledFields["identityEmail"]) === null || _z === void 0 ? void 0 : _z.value) || "",
                    username: ((_0 = this.userFilledFields["identityUsername"]) === null || _0 === void 0 ? void 0 : _0.value) || "",
                };
    ...
    findSubmitButton(element) {
        const genericSubmitElement = this.querySubmitButtonElement(element, "[type='submit']", (node) => nodeIsTypeSubmitElement(node));
        if (genericSubmitElement) {
            return genericSubmitElement;
        }
        const submitButtonElement = this.querySubmitButtonElement(element, "button, [type='button']", (node) => nodeIsButtonElement(node));
    ...
    qualifyUserFilledLoginField(autofillFieldData) {
        for (const [fieldQualifier, fieldQualifierFunction] of Object.entries(this.loginFieldQualifiers)) {
...
class DomQueryService {
     ...
     */
    queryAllTreeWalkerNodes(rootNode, filterCallback, mutationObserver) {
        const treeWalkerQueryResults = [];
        this.buildTreeWalkerNodesQueryResults(rootNode, treeWalkerQueryResults, filterCallback, mutationObserver);
     ...
     * @param mutationObserver
     */
    buildTreeWalkerNodesQueryResults(rootNode, treeWalkerQueryResults, filterCallback, mutationObserver) {
        ...
        while (currentNode) {
            ...
            if (nodeShadowRoot) {
                ...
                this.buildTreeWalkerNodesQueryResults(nodeShadowRoot, treeWalkerQueryResults, filterCallback, mutationObserver);
            }
...
class AutofillInit {
     ...
     */
    constructor(domQueryService, autofillOverlayContentService, autofillInlineMenuContentService, overlayNotificationsContentService) {
        this.autofillOverlayContentService = autofillOverlayContentService;
...
;// CONCATENATED MODULE: ./src/autofill/content/bootstrap-autofill-overlay-menu.ts
...
(function (windowContext) {
    if (!windowContext.bitwardenAutofillInit) {
        ...
        const autofillOverlayContentService = new AutofillOverlayContentService(domQueryService, inlineMenuFieldQualificationService);
        let inlineMenuElements;
        if (globalThis.self === globalThis.top) {
            inlineMenuElements = new AutofillInlineMenuContentService();
        }
        windowContext.bitwardenAutofillInit = new autofill_init(domQueryService, autofillOverlayContentService, inlineMenuElements);
